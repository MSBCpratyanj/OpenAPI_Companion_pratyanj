...
| [Native Side Panel](./15_SIDE-PANEL-PHASE-1.md) | chrome.sidePanel hosts the whole UI; headless-agent content script (RPC + state + event bridge); injected sidebar removed; opens via toolbar / ⌘⇧O shortcut / in-page launcher; ⌘K endpoint search renders in the page (top-centered); live Home dashboard | 🟢 P2 done | 407 unit · 2 E2E |
...
| Metric | Value |
|---|---|
| Automated tests | **407 unit + 2 E2E**, all passing |

...
export class HistoryService {
  ...
  /**
   * Jump to the endpoint in Swagger (expand + scroll) WITHOUT executing it —
   * "Locate" (FR-010). Lets the user find where a past request lives.
   */
  locate(endpointId: string): Result<void> {
    return this.adapter.openEndpoint(endpointId)
  }
